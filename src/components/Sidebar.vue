<template>
  ...
  <nav class="sidebar bg-white dark:bg-gray-800">
    ...
    <div class="sidebar-head p-4">
      ...
      >        
        <h2
          class="text-2xl font-normal ml-1 mt-2 text-gray-800 dark:text-gray-200"
          translate="no"
        >
          Easy Pay<span class="text-primary">.</span>
        </h2>
      </router-link>      
      <button
        ...
        <div class="wrap-item mt-4 dark:text-gray-500">
          ...
          <div class="item mt-3">
            <menu-accordion>
              ...
              <template v-slot:title> API </template>
      ...
      <div class="pb-5">
        ...
        <div class="item mt-3">
          <menu-accordion>
            ...
            <template v-slot:title> Exporteer logs </template>
            <template v-slot:content>
              <p class="text-gray-800 dark:text-gray-500">...</p>
            </template>
          </menu-accordion>
        </div>
      </div>
